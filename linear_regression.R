...
#Based on these values, this model is only slightly better.
...
en.met.by.waste <- lm(energy ~ metro * waste, data = states.data)

##   2. Try adding region to the model. Are there significant differences
##      across the four regions?
en.met.region <- lm(energy ~ metro * waste + region, data = states.data)
anova(en.met.region)
#No, there are no significant differences by region, based on the significance codes in the anova table.